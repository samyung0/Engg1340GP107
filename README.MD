...
- __save (filename)__: _save the game files to [name].json format if a filename is provided, save the game files to [level]-[yyyy]:[mm]:[dd]:[hh]:[mm]:[ss].json otherwise_
